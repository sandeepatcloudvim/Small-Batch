...
{
    RDLCLayout = './StandardSalesInvoiceCBR.rdlc';
    WordLayout = './StandardSalesInvoiceCBR.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(QtyOnSalesOrder; QtyOnSalesOrder)
                {
                    DecimalPlaces = 0 : 5;
                }
                column(JobNo; JobNo)
                ...
                begin
                    ...
                    GetOrderedQtyOnSalesOrder(Line."Order No.", Line."Order Line No.", Line."No.");
    ...
    var
        ...
        recPostedSalesLine: Record "Sales Invoice Line";
    ...
    local procedure GetOrderedQtyOnSalesOrder(DocNo: Code[20]; LineNo: Integer; ItemNo: Code[20])
    var
    ...
    begin
        ...
        IF recSalesLine.FINDFIRST THEN BEGIN
            QtyOnSalesOrder := recSalesLine.Quantity;
        END else begin
            recSalesLineArchive.Reset();
            recSalesLineArchive.SetRange("Document Type", recSalesLineArchive."Document Type"::Order);
            recSalesLineArchive.SetRange("No.", DocNo);
            recSalesLineArchive.SETRANGE("Line No.", LineNo);
            recSalesLineArchive.SETRANGE("No.", ItemNo);
            IF recSalesLineArchive.FINDFIRST THEN begin
                QtyOnSalesOrder := recSalesLineArchive.Quantity;
            end ELSE BEGIN
                recPostedSalesLine.RESET;
                recPostedSalesLine.SETRANGE("Order No.", DocNo);
                recPostedSalesLine.SETRANGE("No.", ItemNo);
                recPostedSalesLine.CALCSUMS(Quantity);
                QtyOnSalesOrder := recPostedSalesLine.Quantity;
            END
        end;
    end;
