report 50006 "Sales - Order Conf. CBR"
{
    RDLCLayout = './StandardSalesOrderConfCBR.rdl';
    WordLayout = './StandardSalesOrderConfCBR.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(CreditsApplied; Format(Header."Credits Applied", 0, AutoFormat.ResolveAutoFormat("Auto Format"::AmountFormat, Header."Currency Code")))
                {

                }
                column(BalanceDue; Format((TotalAmountInclVAT - Header."Credits Applied"), 0, AutoFormat.ResolveAutoFormat("Auto Format"::AmountFormat, Header."Currency Code")))
                {
